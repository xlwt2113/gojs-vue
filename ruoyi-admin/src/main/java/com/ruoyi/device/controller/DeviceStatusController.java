...
public class DeviceStatusController extends BaseController
{
    ...
    @ResponseBody
    public AjaxResult searchDeviceStatus(@RequestParam HashMap map){
        return AjaxResult.success(deviceStatusService.selectDeviceStatusListByDeviceIds(map.get("deviceIds").toString()));
    }
}

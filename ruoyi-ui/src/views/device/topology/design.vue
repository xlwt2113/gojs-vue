...
export default {
  ...
  mounted() {
    ...
    // 定义节点连接线样式
    this.myDiagram.linkTemplate = ('', GO(go.Link, // the whole link panel
      {
    ...
    this.myDiagram.linkTemplateMap.add('link2', GO(go.Link, // the whole link panel
      {
  ...
  methods: {
    ...
    clickNode(e) {
      ...
      if (part.data.key) {
        ...
        part.category === '' ? part.category = 'link2' : part.category = ''
      }
    },
